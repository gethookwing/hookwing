...
export const WEBHOOK_SOURCES: WebhookSource[] = [
  {
    ...
    signature: {
      ...
      description:
        'Stripe signs with HMAC-SHA256 using a per-endpoint secret. The signature header contains a timestamp and one or more versioned signatures.',
    },
...

  {
    ...
    eventCategories: [
      ...
      {
        name: 'Releases',
        eventTypes: ['release.published', 'release.created', 'release.edited', 'release.deleted'],
      },
    ],
    eventTypes: [
      'pull_request.opened',
    ...
    signature: {
      ...
      description:
        'GitHub signs the payload with HMAC-SHA256 using the webhook secret. The header value is prefixed with "sha256=".',
    },
    recommendedEventTypes: [
      'pull_request.opened',
      'pull_request.closed',
...

  {
    ...
    eventCategories: [
      ...
      {
        name: 'Checkouts',
        eventTypes: ['checkouts/create', 'checkouts/update', 'carts/create', 'carts/update'],
      },
      {
        name: 'Fulfillment',
        eventTypes: ['fulfillments/create', 'fulfillments/update', 'fulfillment_events/create'],
      },
    ],
    eventTypes: [
      'orders/create',
    ...
    signature: {
      ...
      description:
        'Shopify signs the payload body with HMAC-SHA256 using the app secret key. The signature is base64-encoded.',
    },
    recommendedEventTypes: [
      'orders/create',
      'orders/paid',
...

  {
    ...
    eventCategories: [
      {
        name: 'Issues',
        eventTypes: ['Issue.create', 'Issue.update', 'Issue.remove'],
      },
      {
        name: 'Comments',
        eventTypes: ['Comment.create', 'Comment.update', 'Comment.remove'],
      },
      {
        name: 'Projects',
        eventTypes: ['Project.create', 'Project.update', 'Project.remove'],
      },
      {
        name: 'Cycles',
        eventTypes: ['Cycle.create', 'Cycle.update', 'Cycle.remove'],
      },
      {
        name: 'Labels',
        eventTypes: ['IssueLabel.create', 'IssueLabel.update', 'IssueLabel.remove'],
      },
    ],
    eventTypes: [
      'Issue.create',
    ...
    signature: {
      ...
      description:
        'Linear signs the payload with HMAC-SHA256 using the webhook signing secret. The header value is hex-encoded.',
    },
    recommendedEventTypes: [
      'Issue.create',
      'Issue.update',
