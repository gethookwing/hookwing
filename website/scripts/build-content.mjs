...
function siteStyles() {
  return `
    ...
    *,*::before,*::after{box-sizing:border-box;margin:0;padding:0}
    html{font-family:var(--font-body);font-size:16px;line-height:1.625;color:var(--color-ink-strong);background:var(--color-bg);-webkit-font-smoothing:antialiased;-moz-osx-font-smoothing:grayscale;scroll-behavior:smooth}
    ...
    [data-theme="dark"] .nav{background:#141E2E;border-color:#1E2D44}
      ...
      <div class="container">
        <div class="nav-inner">
          ...
          <div class="nav-actions">
            ...
            <a href="/getting-started/" class="btn btn-primary btn-md">Start free</a>
          </div>
