...
function siteStyles() {
  return `
    ...
    *{box-sizing:border-box}
    ...
    .card{background:var(--color-surface);border:1px solid var(--color-border);height:100%;border-radius:var(--radius-card);padding:16px;box-shadow:var(--shadow-card)}
    ...
    @media (min-width:700px){
      ...
      .cards{grid-template-columns:repeat(2,minmax(0,1fr));align-items:stretch}
...
<body>
  <div class="shell">
    <header class="topnav">
      <a class="brand" href="/" aria-label="Hookwing — home">
      ...
      <nav class="navlinks" aria-label="Primary">
        ...
        <a href="/docs/">Docs</a>
        <a href="/blog/">Blog</a>
        <a href="/why-hookwing/">Why Hookwing</a>
        <a href="/getting-started/">Get started</a>
        ${nav}
      </nav>
    </header>
    ${content}
    <footer class="footer-note">© ${new Date().getFullYear()} Hookwing · Built for developers and AI agents · <a href="/docs/">Docs</a> · <a href="/blog/">Blog</a> · <a href="/privacy/">Privacy</a> · <a href="/terms/">Terms</a></footer>
  </div>
</body>
</html>`;
}
