...
ALTER TABLE workspaces ADD COLUMN IF NOT EXISTS email TEXT NOT NULL DEFAULT '';
ALTER TABLE workspaces ADD COLUMN IF NOT EXISTS password_hash TEXT NOT NULL DEFAULT '';
